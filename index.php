			...
			<div class="row">
				<div class="intro-content col-sm-6 col-7">
					...
					<a href="https://xn--80aumx.xn--p1ai" target="_blank">
						<div>
							<img class="logo-intro" src="img/logo_akfo.svg" alt="">
						</div>
					</a>

					<a href="https://www.nod.su" target="_blank">
						<div>
							<img class="logo-intro" src="img/logo_nod.svg" alt="">
						</div>
		...
		<div class="container container-fluid">
			...
			<div class="partners">
				...
				<div class="partner-logo">
					<img class="logo-akfo" src="img/logo_akfo_1.svg" alt="">
				</div>
				...
				<div class="partner-logo">
					<img class="logo-5ka" src="img/logo_5ka.svg" alt="">
				</div>

				<div class="partner-logo vkusvill">
					<img class="logo-vkusvill" src="img/Vkusvill_textlogo_2021.svg" alt="">
				</div>
				...
				<div class="partner-logo">
					<img class="logo-nod" src="img/nod_logo 1.svg" alt="">
				</div>
			</div>
		</div>
	</section>
